...
<div align="center">
  <img src="./public/logo.svg" alt="TorqueNotebook — BeamNG.drive — Dynamics" width="64" height="64">
  <h1>TorqueNotebook — BeamNG.drive — Dynamics</h1>
</div>

An independent project specification for BeamNG.drive, covering vehicle configuration diffs, repeatable track scenarios, telemetry import schema.
...
<img src="./public/screenshots/desktop-main.svg" alt="BeamNG.drive — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="BeamNG.drive — compact concept, not a screenshot" width="250">
<br>
...
- **Vehicle configuration diffs** — planned module; not implemented.
- **Repeatable track scenarios** — planned module; not implemented.
- **Telemetry import schema** — planned module; not implemented.

The proposed workflow separates vehicle configuration diffs from repeatable track scenarios, with telemetry import schema retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Vehicle configuration diffs**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TorqueNotebook — BeamNG.drive — Dynamics — specification review workflow">
<br>
...
### Vehicle configuration diffs

Define the input and expected outcome for module 1. Record the BeamNG.drive version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Repeatable track scenarios

Define the input and expected outcome for module 2. Record the BeamNG.drive version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Telemetry import schema

Define the input and expected outcome for module 3. Record the BeamNG.drive version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Vehicle configuration diffs |
